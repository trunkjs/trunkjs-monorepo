export type TScopeMeta = Record<string, any>;
...
export type TBoundScopeValue<
  VD extends TValueDefinition<any, any, any, any>,
  SD extends TScopeDefinition = TScopeDefinition,
  M extends TScopeMeta = TScopeMeta,
> = {
  value: TInferValueType<VD>;
  $meta: M;

  $$: TValueDefinition<any, SD, TInferValueType<VD>, M>;
  $scope: TScope<SD, M>;
};
...
> = {
  ...
  $scope: TScope<SD, M>;
  length: number;
  at(index: number): TScope<Item, M>;
  first(): TScope<Item, M>;
  last(): TScope<Item, M>;
  [index: number]: TScope<Item, M>;
  [Symbol.iterator](): IterableIterator<TScope<Item, M>>;
};
 ...
 * ```
 */
export type TScope<SD extends TScopeDefinition = TScopeDefinition, M extends TScopeMeta = TScopeMeta> = {
  $$: TScopeRuntimeDefinition<SD, M>;
  $meta: M;
  with<K extends string, ND extends TValueDefinition<any, any, any, any>>(
    key: TNewScopeKey<SD, K>,
    definition: ND,
  ): asserts this is TScope<TExtendScopeDefinition<SD, K, ND>, M>;
  ...
  withArray<K extends string, ND extends TScopeDefinition>(
    key: TNewScopeKey<SD, K>,
    definition: ND,
  ): asserts this is TScope<TExtendScopeDefinition<SD, K, TArrayDefinition<ND>>, M>;
} & {
  [K in keyof SD]: SD[K] extends TValueDefinition<any, any, any, any>
    ? TScopeValue<SD[K], SD, M>
    : SD[K] extends TScopeDefinition<any>
      ? TScope<SD[K], M>
      : SD[K] extends TArrayDefinition<infer Item>
        ? TScopeArray<Item, SD, M>
        : never;
};
...
> = {
  ...
  $meta: M;
  $scope: TScope<SD, M>;
  $$: TValueDefinition<any, SD, TInferValueType<TV>, M>;
};
 ...
 * ```
 */
export type TScopeValueListener<
  TVC extends TScopeValue<any, any, any>,
  SD extends TScopeDefinition = TScopeDefinition,
  M extends TScopeMeta = TScopeMeta,
> = (value: TVC, event: Event) => void;
...
export type TScopeEntryDefinition =
  | TValueDefinition<any, any, any, any>
  | TScopeDefinition
 ...
 * ```
 */
export type TInferValueType<TV extends TValueDefinition<any, any, any, any>> =
  TV extends TValueDefinition<any, any, infer V, any> ? V : never;
 ...
 * ```
 */
export type TScopeEntry<ND extends TScopeEntryDefinition, M extends TScopeMeta = TScopeMeta> =
  ND extends TValueDefinition<any, any, any, any>
    ? TScopeValue<ND, TScopeDefinition, M>
    : ND extends TScopeDefinition
      ? TScope<ND, M>
      : ND extends TArrayDefinition<infer Item>
        ? TScopeArray<Item, TScopeDefinition, M>
        : never;
...
> = {
  defaultValue?: V;
  onclick?: TScopeValueListener<TScopeValue<TValueDefinition<P, SD, V, M>, SD, M>, SD, M>;
};
 ...
 * ```
 */
export type TScopeRuntimeDefinition<SD extends TScopeDefinition, M extends TScopeMeta = TScopeMeta> = {
  [K in keyof SD]: SD[K] extends TValueDefinition<any, any, infer V, any>
    ? TValueDefinition<Extract<K, string>, SD, V, M>
    : SD[K] extends TScopeDefinition<any>
      ? TScopeRuntimeDefinition<SD[K], M>
      : SD[K] extends TArrayDefinition<infer Item>
        ? TArrayDefinition<Item>
        : never;
};
...
export function createScope<SD extends TScopeEntryDefinition, M extends TScopeMeta = TScopeMeta>(
  definition: SD,
): TScopeEntry<SD, M> {
  return undefined as unknown as TScopeEntry<SD, M>;
}

export function withScopeKey<
  SD extends TScopeDefinition,
  K extends string,
  ND extends TScopeEntryDefinition,
  M extends TScopeMeta = TScopeMeta,
>(
  ...
  key: TNewScopeKey<SD, K>,
  definition: ND,
): asserts scope is TScope<TExtendScopeDefinition<SD, K, ND>, M> {
...
>(
  ...
  key: TNewScopeKey<SD, K>,
  definition: ND,
): asserts scope is TScope<TExtendScopeDefinition<SD, K, TArrayDefinition<ND>>, M> {
