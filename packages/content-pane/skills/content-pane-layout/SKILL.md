...
description: Use whenever a layout attribute for @trunkjs/content-pane is found, read, written, explained, or changed; covers layout transformation, selectors, and the i index.
---
